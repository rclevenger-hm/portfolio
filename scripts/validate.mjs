...
for(const t of ["Principal Site Reliability Engineer","Sports Gamecast","OCI Ephemeral Resource Janitor","Kafka on OCI","case-studies/oci-ephemeral-resource-janitor"]) if(!llms.includes(t)){console.error("llms.txt missing",t);bad=true;}
